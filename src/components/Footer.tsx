      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">AIToolsIndia</h3>
            <p className="text-gray-400 mb-4">
              Empowering every Indian to leverage AI—no cost, no signup. 
              Discover the best free AI tools curated for students, creators, and professionals.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 AIToolsIndia. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
